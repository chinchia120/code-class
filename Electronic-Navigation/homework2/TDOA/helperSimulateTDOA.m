function detections = helperSimulateTDOA(scenario, rxPairs, measNoise, reportIdentity, Pd, nFalse)
    ...
    % This function simulates TDOA for each TDOA pair defined in the input, tdoaPairs. 
    %
    ...
    % MeasurementParameters - A 2-by-1 struct defining the position of receivers in the scenario. Each struct has field "OriginPosition" which represents the position of the receivers. 
