...
% fault_x{1}=[120.390300 120.335412 120.280525 120.225638 120.170750 120.115862 120.060975 120.006088 119.951200 119.878017 119.804833 119.731650 119.658467 119.585283 119.512100];
% fault_y{1}=[23.089800 23.081375 23.072950 23.064525 23.056100 23.047675 23.039250 23.030825 23.022400 23.011183 22.999967 22.988750 22.977533 22.966317 22.955100 ];
% dep{1}=[0.000000 2.500000 5.000000 7.500000 10.000000 12.500000 15.000000 17.500000 20.000000 22.500000 25.000000 ]; %top depth of fault
% dp{1}=[20.000000 20.000000 20.000000 20.000000 20.000000 20.000000 20.000000 20.000000 20.000000 20.000000 ]; %fault dip
% % dp{1} = ones(1, 10) * 20.0;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%input parameters
%datatype = 1 for horizontal velocity | format: lon (°), lat (°), Deast (mm/yr), Dnorth (mm/yr), Sigeast (mm/yr), Signorth (mm/yr)
%datatype = 2 for vertical velocity | format: lon (°), lat (°), Dup (mm/yr), Sigup (mm/yr)
%datatype = 3 for insar los velocity | format: lon (°), lat (°), Dlos (mm/yr), Siglos (mm/yr)
%weightdata: larger value, lower weighting
input_file{1}='disp_h_CGPS2.dat'; %input file name
datatype{1}=1;
weightdata{1}=1;
look{1}=NaN; %[flight_direction,looking angle] for InSAR data -- not applicable for other geodetic data
input_file{2}='disp_u_CGPS2.dat'; %input file name
datatype{2}=2;
weightdata{2}=1;
%{
look{2}=NaN; %[flight_direction,looking angle] for InSAR data -- not applicable for other geodetic data
