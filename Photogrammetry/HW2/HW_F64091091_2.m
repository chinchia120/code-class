...
while true
    ...
    if max(abs(X_)) < sigma/10
        ...
        for tmp_case = 1: 12
            if tmp_case == 1
                photo_cor = vpa(collinearity(x0, y0, f, Xp_, Yp_, Zp_, cor_ABCD(01, 1), cor_ABCD(01, 2), cor_ABCD(01, 3), R_A));     
            elseif tmp_case == 2
                photo_cor = vpa(collinearity(x0, y0, f, Xp_, Yp_, Zp_, cor_ABCD(02, 1), cor_ABCD(02, 2), cor_ABCD(02, 3), R_A));
            elseif tmp_case == 3
                photo_cor = vpa(collinearity(x0, y0, f, Xp_, Yp_, Zp_, cor_ABCD(03, 1), cor_ABCD(03, 2), cor_ABCD(03, 3), R_A));
            elseif tmp_case == 4
                photo_cor = vpa(collinearity(x0, y0, f, Xp_, Yp_, Zp_, cor_ABCD(04, 1), cor_ABCD(04, 2), cor_ABCD(04, 3), R_B));
            elseif tmp_case == 5
                photo_cor = vpa(collinearity(x0, y0, f, Xp_, Yp_, Zp_, cor_ABCD(05, 1), cor_ABCD(05, 2), cor_ABCD(05, 3), R_B));
            elseif tmp_case == 6
                photo_cor = vpa(collinearity(x0, y0, f, Xp_, Yp_, Zp_, cor_ABCD(06, 1), cor_ABCD(06, 2), cor_ABCD(06, 3), R_B));
            elseif tmp_case == 7
                photo_cor = vpa(collinearity(x0, y0, f, Xp_, Yp_, Zp_, cor_ABCD(07, 1), cor_ABCD(07, 2), cor_ABCD(07, 3), R_C));
            elseif tmp_case == 8
                photo_cor = vpa(collinearity(x0, y0, f, Xp_, Yp_, Zp_, cor_ABCD(08, 1), cor_ABCD(08, 2), cor_ABCD(08, 3), R_C));
            elseif tmp_case == 9
                photo_cor = vpa(collinearity(x0, y0, f, Xp_, Yp_, Zp_, cor_ABCD(09, 1), cor_ABCD(09, 2), cor_ABCD(09, 3), R_C));
            elseif tmp_case == 10
                photo_cor = vpa(collinearity(x0, y0, f, Xp_, Yp_, Zp_, cor_ABCD(10, 1), cor_ABCD(10, 2), cor_ABCD(10, 3), R_D));
            elseif tmp_case == 11
                photo_cor = vpa(collinearity(x0, y0, f, Xp_, Yp_, Zp_, cor_ABCD(11, 1), cor_ABCD(11, 2), cor_ABCD(11, 3), R_D));
            elseif tmp_case == 12
                photo_cor = vpa(collinearity(x0, y0, f, Xp_, Yp_, Zp_, cor_ABCD(12, 1), cor_ABCD(12, 2), cor_ABCD(12, 3), R_D));
            end
