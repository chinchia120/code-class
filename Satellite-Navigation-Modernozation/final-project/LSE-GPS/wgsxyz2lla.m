...
% Function [lat, lon, alt] = wgsxyz2lla(xyz) transforms the 3 x 1 vector xyz representing a point in WGS84 xyz coordinates
% into its corresponding latitude (degrees), longitude (degrees), and height above WGS84 ellipsoid (in meters).

% This dual-variable iteration seems to be 7 or 8 times faster than a one-variable (in latitude only) iteration. 
