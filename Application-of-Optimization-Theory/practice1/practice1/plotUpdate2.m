function stop = plotUpdate2(x, optimValues, state)
...
if isempty(h)
    ...
    fobjfcn = @(x,y) (x-1)^2 + (y-2)^2;
    fcontour(fobjfcn, [0 5], 'LevelStep', 0.3);
...
% Tag already plotted points with new tag to preserve them 'SurfacePoints' tag will be used for next plot
