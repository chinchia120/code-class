...
for idx = 1: size(x0, 1)
    ...
    WriteOutFile(point, output, time, iter, loss, points_array, values_array, 'Newton Method', OutputFile1);
    ...
    WriteOutFile(point, output, time, iter, loss, points_array, values_array, 'Steepest Descent Method', OutputFile1);
    ...
    WriteOutFile(point, output, time, iter, loss, points_array, values_array, 'Conjugate Gradient Method', OutputFile1);
...
for idx = 1: size(x0, 1)
    % ===== Newton Method
    [point, output, time, iter, loss, points_array, values_array] = newton_method(f, f_gradient, f_hessian, x0(idx, :), epsilon, max_iter, ub, lb);
    WriteOutFile(point, output, time, iter, loss, points_array, values_array, 'Newton Method', OutputFile2);
    ...
    % ===== Steepest Descent Method
    [point, output, time, iter, loss, points_array, values_array] = gradient_descent(f, f_gradient, x0(idx, :), epsilon, max_iter, ub, lb);
    WriteOutFile(point, output, time, iter, loss, points_array, values_array, 'Steepest Descent Method', OutputFile2);
    ...
    % ===== Conjugate Gradient Method
    [point, output, time, iter, loss, points_array, values_array] = nonlinear_CG(f_approx, f, f_gradient_cg, x0(idx, :), epsilon, max_iter, ub, lb);
    WriteOutFile(point, output, time, iter, loss, points_array, values_array, 'Conjugate Gradient Method', OutputFile2);
...
for idx = 1: size(x0, 1)
    % ===== Newton Method
    [point, output, time, iter, loss, points_array, values_array] = newton_method(f, f_gradient, f_hessian, x0(idx, :), epsilon, max_iter, ub, lb);
    WriteOutFile(point, output, time, iter, loss, points_array, values_array, 'Newton Method', OutputFile3);
    ...
    % ===== Steepest Descent Method
    [point, output, time, iter, loss, points_array, values_array] = gradient_descent(f, f_gradient, x0(idx, :), epsilon, max_iter, ub, lb);
    WriteOutFile(point, output, time, iter, loss, points_array, values_array, 'Steepest Descent Method', OutputFile3);
    ...
    % ===== Conjugate Gradient Method
    [point, output, time, iter, loss, points_array, values_array] = nonlinear_CG(f_approx, f, f_gradient_cg, x0(idx, :), epsilon, max_iter, ub, lb);
    WriteOutFile(point, output, time, iter, loss, points_array, values_array, 'Conjugate Gradient Method', OutputFile3);
