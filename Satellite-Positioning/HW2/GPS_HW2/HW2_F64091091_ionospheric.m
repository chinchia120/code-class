...
%% ---------------- output txt ---------------- %%
file = fopen('CK01_output_ionospheric.txt', 'w');
...
%% ----------------- save plot ---------------- %%
saveas(gcf, './picture//positioning_error_ionospheric.png');
...
%% ----------------- save plot ---------------- %%
saveas(gcf, './picture//DOP_ionospheric.png');